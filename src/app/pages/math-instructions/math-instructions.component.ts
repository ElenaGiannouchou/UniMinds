...
@Component({
  selector: 'app-math-instructions',
  imports: [],
  templateUrl: './math-instructions.component.html',
  styleUrl: './math-instructions.component.css'
})
export class MathInstructionsComponent {
